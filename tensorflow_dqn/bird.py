...
"""
原地址： https://github.com/yenchenlin/DeepLearningFlappyBird
"""
import sys
import cv2
...
def conv2d(x, W, stride):
    ...
    # strides为卷积核的移动步长，padding为卷积的一种模式，参数为same，表示滑动范围超过边界时
...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    while "flappy bird" != "angry bird":
        ...
        print("TIMESTEP", t, "/ STATE", state, "/ EPSILON",
              epsilon, "/ ACTION", action_index, "/ REWARD", r_t,
